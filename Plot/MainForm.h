...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->OpenGL_Container->Size = System::Drawing::Size(759, 555);
			this->OpenGL_Container->TabIndex = 0;
			this->OpenGL_Container->TabStop = false;
			this->OpenGL_Container->Text = L"График";
			// 
			// equationTextbox
			// 
			...
			this->plotButton->Text = L"Построить";
			...
			this->groupBox1->Location = System::Drawing::Point(778, 37);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(196, 579);
			this->groupBox1->TabIndex = 5;
			this->groupBox1->TabStop = false;
			this->groupBox1->Text = L"Отображаемые уравнения";
			// 
			// toggleColorButton
			// 
			...
			this->toggleColorButton->Text = L"Изменить цвет ";
			...
			this->removeSelectedButton->Text = L"Удалить выбранное";
			...
			this->clearAllButton->Text = L"Удалить все";
			...
			this->graphListView->Font = (gcnew System::Drawing::Font(L"Consolas", 9, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->graphListView->HideSelection = false;
			...
			this->statusStrip1->Size = System::Drawing::Size(989, 22);
			...
			this->cameraStatusStrip->Size = System::Drawing::Size(118, 17);
			...
			this->defaultView->Size = System::Drawing::Size(129, 23);
			this->defaultView->TabIndex = 9;
			this->defaultView->Text = L"Вид по умочанию";
			...
			this->editToolStripMenuItem->Size = System::Drawing::Size(79, 20);
			this->editToolStripMenuItem->Text = L"Настройки";
			// 
			// graphPropertiesToolStripMenuItem
			// 
			this->graphPropertiesToolStripMenuItem->Name = L"graphPropertiesToolStripMenuItem";
			this->graphPropertiesToolStripMenuItem->Size = System::Drawing::Size(187, 22);
			this->graphPropertiesToolStripMenuItem->Text = L"Параметры графика";
			...
			this->ClientSize = System::Drawing::Size(989, 649);
